...
| 메뉴 | 기능 |
|------|------|
| **대시보드** | 오늘/이번주/이번달 휴가자, 팀별 휴가 인원, 잔여연차 Bottom·사용률 Top, 동시 휴가 리스크 경고 |
| **캘린더** | 월간 그리드, 팀/직원/유형 필터, 유형별 색상, 공휴일 표시 |
| **직원 관리** | 직원 CRUD, 팀/직급/상태/이름 필터, 직원별 잔여연차 |
| **휴가 등록** | 휴가 등록/수정/삭제, 상태 변경, 반차 처리, 예상 사용일수 미리보기 |
| **팀 현황** | 팀별 인원·잔여연차 합계·예정 휴가 일정 |
| **설정** | 연차 계산 기준, 팀별 경고 기준, 휴가 유형, 공휴일 관리, 데이터 저장소 상태 |

...
const ko: Dict = {
  ...
  "settings.countryDefaults": "국가별 기본 연차",
  "settings.countryNamePh": "새 국가/지사 이름",
  "settings.countryNote": "직원 추가 시 국가를 선택하면 이 기본 연차가 자동으로 채워집니다 (직원별로 수정 가능).",
  "settings.confirmDeleteCountry": "국가를 삭제할까요?",
  "settings.countryInUse": "이 국가로 지정된 직원이 있어 삭제할 수 없습니다.",
  "settings.dupCountry": "이미 있는 국가입니다.",
...
const en: Dict = {
  ...
  "employees.field.country": "Country / Office",
  ...
  "settings.countryDefaults": "Default Annual Leave by Country",
  "settings.countryNamePh": "New country / office name",
  "settings.countryNote": "When adding an employee, selecting a country auto-fills this default (editable per employee).",
  "settings.confirmDeleteCountry": "Delete this country?",
  "settings.countryInUse": "Employees are assigned to this country, so it cannot be deleted.",
  "settings.dupCountry": "This country already exists.",

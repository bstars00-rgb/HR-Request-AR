...
const ko: Dict = {
  ...
  // 일정 카테고리
  "category.Fair": "박람회/세일즈콜",
  "category.Trip": "출장",
  "category.Internal": "내부업무/OKR",
  "category.Personal": "개인/휴가",
  "category.Other": "기타",
  ...
  // 대시보드
  "dash.title": "대시보드",
  "dash.subtitle": "기준 일정 현황",
  "dash.todayLeavers": "오늘 일정",
  "dash.weekLeavers": "이번 주 일정",
  "dash.monthLeavers": "이번 달 일정",
  "dash.riskAlerts": "오늘 자리 비움",
  "dash.next14": "출장·개인/휴가",
  "dash.riskTitle": "유형별 오늘 일정",
  "dash.threshold": "기준",
  "dash.todayOnLeave": "오늘 일정",
  "dash.noTodayLeave": "오늘 등록된 일정이 없습니다.",
  "dash.teamTodayCount": "팀별 오늘 일정 수",
  "dash.bottomRemaining": "이번 주 다가오는 일정",
  "dash.topUsage": "유형별 이번 달 일정 수",
  "dash.addLeave": "일정 등록",

  // 캘린더
  "cal.title": "일정 캘린더",
  "cal.subtitle": "팀·구성원·유형별로 일정을 한눈에 확인",
  "cal.prevMonth": "이전 달",
  "cal.nextMonth": "다음 달",
  "cal.more": "명 더",
  ...
  // 휴가
  "leaves.title": "일정 등록 / 공유",
  "leaves.subtitle": "본인 일정을 등록하고 팀 전체와 공유합니다",
  "leaves.editLeave": "일정 수정",
  "leaves.empty": "등록된 일정이 없습니다.",
  "leaves.col.employee": "구성원",
  "leaves.col.type": "유형",
  "leaves.col.period": "기간",
  "leaves.col.days": "일수",
  "leaves.col.reason": "내용",
  "leaves.confirmDelete": "이 일정을 삭제할까요?",

  // 휴가 폼
  "form.employee": "구성원 (본인)",
  "form.leaveType": "유형",
  "form.startDate": "시작일",
  "form.endDate": "종료일",
  "form.endDateHalf": "종료일",
  "form.halfType": "반차 구분",
  "form.status": "상태",
  "form.reason": "내용 / 제목",
  "form.reasonPlaceholder": "예: China Sales Call, 출장(심천), OKR 미팅 등",
  "form.previewDays": "기간(일)",
  "form.submitNew": "일정 등록",
  ...
  "settings.teamWarn": "팀 관리 · 동시 휴가 경고 기준",
  "settings.orMore": "명 이상",
  "settings.teamAdd": "팀 추가",
  "settings.teamNamePh": "새 팀 이름 (예: Marketing)",
  "settings.confirmDeleteTeam": "팀을 삭제할까요?",
  "settings.teamHasMembers": "이 팀에 소속된 직원이 있어 삭제할 수 없습니다. 먼저 해당 직원들의 팀을 변경하세요.",
  "settings.dupTeam": "이미 있는 팀 이름입니다.",
...
const en: Dict = {
  ...
  "nav.employees": "Members",
  "nav.leaves": "My Schedule",
  "nav.teams": "Teams",
  "nav.settings": "Settings",
  "menu": "Menu",

  "category.Fair": "Fair / Sales Call",
  "category.Trip": "Business Trip",
  "category.Internal": "Internal / OKR",
  "category.Personal": "Personal / Leave",
  ...
  "dash.subtitle": "schedule overview",
  "dash.todayLeavers": "Today",
  "dash.weekLeavers": "This Week",
  "dash.monthLeavers": "This Month",
  "dash.riskAlerts": "Away Today",
  "dash.next14": "Trip · Personal",
  "dash.riskTitle": "Today by Category",
  "dash.threshold": "threshold",
  "dash.todayOnLeave": "Today's Schedule",
  "dash.noTodayLeave": "No schedule entries today.",
  "dash.teamTodayCount": "Today's Entries by Team",
  "dash.bottomRemaining": "Upcoming This Week",
  "dash.topUsage": "This Month by Category",
  "dash.addLeave": "Add Schedule",

  "cal.title": "Schedule Calendar",
  "cal.subtitle": "See schedules by team, member, and category",
  ...
  "leaves.title": "My Schedule",
  "leaves.subtitle": "Add your schedule and share it with the team",
  "leaves.editLeave": "Edit Entry",
  "leaves.empty": "No schedule entries yet.",
  "leaves.col.employee": "Member",
  "leaves.col.type": "Category",
  "leaves.col.period": "Period",
  "leaves.col.days": "Days",
  "leaves.col.reason": "Details",
  "leaves.confirmDelete": "Delete this schedule entry?",

  "form.employee": "Member (you)",
  "form.leaveType": "Category",
  "form.startDate": "Start Date",
  "form.endDate": "End Date",
  "form.endDateHalf": "End Date",
  "form.halfType": "Half-day",
  "form.status": "Status",
  "form.reason": "Details / Title",
  "form.reasonPlaceholder": "e.g. China Sales Call, Trip (Shenzhen), OKR meeting",
  "form.previewDays": "Duration (days)",
  "form.submitNew": "Add Schedule",
  ...
  "settings.teamWarn": "Teams · Overlap Alert Thresholds",
  "settings.orMore": "or more",
  "settings.teamAdd": "Add team",
  "settings.teamNamePh": "New team name (e.g. Marketing)",
  "settings.confirmDeleteTeam": "Delete this team?",
  "settings.teamHasMembers": "This team has members. Reassign their team before deleting.",
  "settings.dupTeam": "A team with this name already exists.",
